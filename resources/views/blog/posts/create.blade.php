...
<div class="container mt-4">
    <h1 class="crud_title">@t('blog_post.title_create')</h1>
    ...
    <form action="{{ route('blog.posts.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                {{-- Image --}}
                <div class="mb-3">
                    <label class="form-label">@t('blog_post.featured_image')</label>
                ...
                <div class="mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="is_published">
                            @t('blog_post.publish_immediately')
                        </label>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">@t('blog_post.published_at_help')</small>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-success">
                <i class="bi bi-save"></i> @t('blog_post.save')
            </button>
