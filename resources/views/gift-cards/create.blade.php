...
<div class="container mt-4">
    <h1 class="crud_title">Créer une carte cadeau</h1>
    ...
    <form action="{{ route('gift-cards.store') }}" method="POST">
        ...
        <button type="submit" class="btn btn-primary btn-lg">
            <i class="bi bi-save"></i> Créer la carte cadeau
        </button>
        <p class="text-muted mt-2">
            <small>Vous pourrez ajouter des catégories après la création de la carte.</small>
        </p>
    </form>
</div>
