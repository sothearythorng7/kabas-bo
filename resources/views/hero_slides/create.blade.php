...
<div class="container mt-4">
  <h1 class="crud_title">{{ __('messages.hero_slide.title_create') }}</h1>
  <form action="{{ route('hero-slides.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
      <label class="form-label">{{ __('messages.hero_slide.image') }}</label>
    ...
    <button type="submit" class="btn btn-success">
      <i class="bi bi-save"></i> {{ __('messages.hero_slide.save') }}
    </button>
