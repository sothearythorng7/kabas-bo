...
<div class="container mt-4">
    <h1 class="crud_title">Paiements fournisseurs - {{ $site->name }}</h1>
    <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('stores.payments.index', $site) }}">Paiements fournisseurs</a>
        </li>
        <li class="nav-item">
    ...
    <a href="{{ route('stores.payments.create', $site) }}" class="btn btn-success mb-3">
        <i class="bi bi-plus-circle-fill"></i> Ajouter un paiement
    </a>
