...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="crud_title mb-0">
            <i class="bi bi-calendar-week"></i> {{ __('messages.planning.monthly_title') }}
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('leave-requests.index') }}" class="btn btn-outline-primary">
                            ...
                            @foreach($planning as $row)
                                <tr>
                                    <td class="sticky-col bg-white">
                                        <a href="{{ route('staff.show', ['staffMember' => $row['employee'], 'tab' => 'leaves']) }}"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-4">
                                <div class="fs-3 fw-bold text-primary">{{ $summary['total_employees'] }}</div>
                                <small class="text-muted">{{ __('messages.planning.employees') }}</small>
                            </div>
                            <div class="col-4">
