...
<div class="header">
    ...
    <div class="header-title">Refill</div>
    <div style="width: 60px;"></div>
</div>

<div class="container">
    <div class="text-sm text-muted mb-4">
        Select a supplier to start a refill
    </div>
    ...
    @if($suppliers->isEmpty())
        <div class="empty-state">
            ...
            <div>No active suppliers available</div>
        </div>
    @else
        ...
        <div id="suppliersList">
            @foreach($suppliers as $supplier)
                <div class="card supplier-card" data-name="{{ strtolower($supplier->name) }}" style="cursor: pointer;" onclick="window.location='{{ route('reception.refill.products', $supplier) }}'">
