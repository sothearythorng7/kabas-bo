    ...
    <form action="{{ route('variation-values.update', $variationValue) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <div class="d-flex align-items-center gap-2">
                <input type="color" id="color_picker" value="{{ old('color_hex', $variationValue->color_hex ?: '#000000') }}" style="width: 50px; height: 38px; padding: 2px;">
                <input type="text" name="color_hex" id="color_hex" class="form-control @error('color_hex') is-invalid @enderror" value="{{ old('color_hex', $variationValue->color_hex) }}" placeholder="#RRGGBB" pattern="^#[0-9A-Fa-f]{6}$" style="max-width: 140px;">
